...
################################################################################
cd  $workDir
mkdir 10_aftrActLearningWithRelaxedVasp
cd 10_aftrActLearningWithRelaxedVasp/

mkdir justPOSCARs/
mkdir runVasp/

mv  $workDir/8_trainingWithRelaxedVasp/POSCAR*  justPOSCARs/
...
do
   echo "POSCAR = " $line
   cd $workDir/10_aftrActLearningWithRelaxedVasp/runVasp/$line
   sbatch jobVasp
done <$file
